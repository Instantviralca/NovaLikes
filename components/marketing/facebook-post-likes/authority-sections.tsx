...
import { FacebookPostLikesHeroDashboard } from '@/components/illustrations/facebook-post-likes-hero-dashboard';
import { FacebookPostLikesOrderStatusDashboard } from '@/components/illustrations/facebook-post-likes-order-status-dashboard';
...
import {
  FACEBOOK_POST_LIKES_PAGE_CONFIG,
  type FacebookPostLikesPageConfig,
} from '@/data/content/facebook-post-likes-page-config';
...
type SectionProps = {
  config?: FacebookPostLikesPageConfig;
  className?: string;
};
...
/** Section 4 — Why do people buy Facebook Post Likes */
export function FacebookPostLikesWhyBuy({
  id,
  title,
  description,
  items,
    ...
    >
      <Container size="xl">
        <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-12 lg:items-center">
          ...
          >
            <FacebookPostLikesOrderStatusDashboard className="max-w-none" />
          </FadeUp>
        </div>
      </Container>
    </Section>
...
/** Section 5 — Can you buy Facebook Post Likes? */
export function FacebookPostLikesCanYouBuy({
  config = FACEBOOK_POST_LIKES_PAGE_CONFIG,
  className,
}: SectionProps) {
    ...
    >
      <Container size="xl">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-14">
          ...
          >
            <FacebookPostLikesOrderSummaryDashboard className="max-w-none" />
          </FadeUp>
...
/** Section 6 — How to buy Facebook Post Likes */
export function FacebookPostLikesHowToBuy({
  id,
  title,
  description,
  steps,
...
/** Section 8 — Does buying Facebook Post Likes help? */
export function FacebookPostLikesDoesBuyingHelp({
  config = FACEBOOK_POST_LIKES_PAGE_CONFIG,
  className,
}: SectionProps) {
      ...
      <Container size="xl">
        ...
        <div className="grid items-stretch gap-5 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.25fr)_minmax(0,0.9fr)] lg:gap-6 xl:gap-7">
          ...
          <FadeUp delay={0.04} className="flex items-center justify-center lg:px-0">
            <FacebookPostLikesAnalyticsDashboard className="w-full max-w-[30rem]" />
          </FadeUp>
...
/** Section 9 — What happens after you buy Facebook Post Likes */
export function FacebookPostLikesWhatHappens({
  config = FACEBOOK_POST_LIKES_PAGE_CONFIG,
  className,
}: SectionProps) {
...
/** Section 10 — Post Likes vs Page Likes vs Followers */
export function FacebookPostLikesServiceCompare({
  config = FACEBOOK_POST_LIKES_PAGE_CONFIG,
  className,
}: SectionProps) {
...
export function FacebookPostLikesPackageSizes({
  config = FACEBOOK_POST_LIKES_PAGE_CONFIG,
  className,
}: SectionProps) {
...
export function FacebookPostLikesBestPractices({
  config = FACEBOOK_POST_LIKES_PAGE_CONFIG,
  className,
}: SectionProps) {
    ...
    >
      <Container size="xl">
        ...
        <FadeUp delay={0.04} className="mx-auto mb-7 max-w-[28rem]">
          <FacebookPostLikesHeroDashboard className="max-w-none" />
        </FadeUp>
...
export function FacebookPostLikesCommonMistakes({
  config = FACEBOOK_POST_LIKES_PAGE_CONFIG,
  className,
}: SectionProps) {
...
export function FacebookPostLikesRelatedArticles({
  articles,
  title = 'Related Articles',
  description = 'Guides that help you strengthen Facebook post engagement alongside Post Like packages.',
}: {
