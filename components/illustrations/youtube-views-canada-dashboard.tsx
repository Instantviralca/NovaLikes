...
/**
 * Global Creator Studio dashboard for Buying YouTube Views worldwide.
 */
export function YouTubeViewsGlobalDashboard({ className }: { className?: string }) {
  const ytRed = '#FF0000';
  const brand = '#F97316';
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-stone-900">Videos</p>
            </div>
          </div>
